...
export interface ReactMdeProps {
  ...
  selectedTab: "write" | "preview" | "help";
  onTabChange: (tab: "write" | "preview" | "help") => void,
      ...
      <div className={classNames("react-mde", "react-mde-tabbed-layout", className)}>
        ...
        />
        {
          selectedTab === "write" ?
            ...
            :
						<div
							className={classNames("mde-preview", { className })}
							style={{ minHeight: minPreviewHeight + 10, padding: '0.5em' }}
							data-testid="mde-preview">
							<MarkdownRenderer content={selectedTab === "help" ? helpMarkdown : value} />
						</div>
        }
      </div>
    );
